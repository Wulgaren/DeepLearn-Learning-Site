...
const JS_UPGRADE_SCRIPT =
  '<script>document.cookie="dl_js=1;path=/;max-age=31536000";document.documentElement.style.backgroundColor="black";window.location.reload();document.write("<!--");</script>';
